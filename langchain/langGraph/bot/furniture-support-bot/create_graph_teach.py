...
class createGraph(BaseTool):
    ...
    description = "这是一个有关于家电领域的智能回答工具，请根据用户的问题给出回答。"
    name = "create_graph"
    def _run(self,question,filename=None):
        ...
        workflow.add_conditional_edges(START, route_node,
                                       {"vector_storage": "vector_storage",
                                        "get_knowledge_type": "get_knowledge_type"})
...
class CreateLLMCustomerService(object):
    ...
    def __init__(self):
        ...
        self.llm = ChatOpenAI(temperature=0.3, model="gpt-4o",base_url="https://api.gptsapi.net/v1")
