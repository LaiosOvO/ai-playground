...
class GradeAndGenerateTool(object):
    ...
    def grade(self, question, text, idx):
        ...
        result = self.llm.invoke(grade_messages)
    ...
    def hallucinations(self, documents, answer):
        ...
        result = self.llm.invoke(hallucinations_messages)
    ...
    def answer_question(self, question, answer):
        ...
        result = self.llm.invoke(answer_question_messages)
        return result.content.strip()
...
#     tool = GradeAndGenerateTool()
#     res = tool.search_vector( "请问多少温度需要将食物放到冰箱" , "refrigerator")
#     print(res)